...
namespace mRingo.Web
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            const string userName = "mRingoApp";
            const string from = "mRingoapp@gmail.com";
            const string password = "J0hn3!16";
            const int port = 587;
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            const string accountSid = "AC3b246ce358843bd2516a997804d44639";
            const string authToken = "7864ca1b2cd885493ee1ccf04c84bba2";
